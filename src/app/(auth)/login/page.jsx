              ...
              <div className="relative z-10 h-full flex flex-col justify-center">
                ...
                <div className="mb-8">
                  ...
                  <p className={`text-white/80 text-sm ${bengaliClass}`}>
                    {language === "bn"
                      ? "আপনার শেখা চালিয়ে যেতে সাইন ইন করুন"
                ...
                <div className="mt-auto pt-6 border-t border-white/20">
                  <p className={`text-sm text-white/80 italic ${bengaliClass}`}>
                    {language === "bn"
                      ? "\"শিক্ষা হলো সবচেয়ে শক্তিশালী অস্ত্র যা দিয়ে আপনি বিশ্ব পরিবর্তন করতে পারেন।\""
            ...
            <div className="lg:col-span-3 p-8 lg:p-12 flex items-center">
              <div className="w-full max-w-md mx-auto">
                <div className="mb-8">
                  ...
                  <p className={`text-gray-500 text-sm ${bengaliClass}`}>
                    ...
                    <Link href="/register" className="text-[#E62D26] font-semibold hover:underline">
                      {language === "bn" ? "একটি তৈরি করুন" : "Create one"}
                    </Link>
                  </p>
                </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        placeholder={language === "bn" ? "you@example.com" : "you@example.com"}
                ...
                <p className={`text-xs text-gray-400 text-center mt-6 ${bengaliClass}`}>
                  {language === "bn"
                    ? "সমস্যা হচ্ছে? আমাদের সাপোর্ট টিমের সাথে যোগাযোগ করুন"
